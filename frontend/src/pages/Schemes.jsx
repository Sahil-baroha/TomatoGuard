import { ExternalLink, Landmark, ShieldCheck, TestTube2, Flower2, Droplets, CreditCard, ShoppingCart } from 'lucide-react'
...
const schemes=[
 ...
 {name:'Pradhan Mantri Krishi Sinchayee Yojana (PMKSY)',desc:'National mission to improve farm productivity and ensure better utilization of the resources in the country through micro irrigation.',url:'https://pmksy.gov.in/',icon:Droplets},
 {name:'Kisan Credit Card (KCC)',desc:'Credit support to farmers for their cultivation and other needs, offering short-term loans at low interest rates.',url:'https://sbi.co.in/web/agri-rural/agriculture-banking/crop-loan/kisan-credit-card',icon:CreditCard},
 {name:'National Agriculture Market (e-NAM)',desc:'Pan-India electronic trading portal linking APMCs to create a unified national market for agricultural commodities.',url:'https://www.enam.gov.in/',icon:ShoppingCart}
]
